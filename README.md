...
*   🚀 **התממשקות מהירה למודל**: בנינו את ממשק התקשורת עם המודל על בסיס שפת go lang
...
הממשק זמין בכתובת **localhost:8004** ותומך ב:
> - **היסטוריית שיחות**
> - **העלאת קבצים**
...
| **New Frontend** | `8004` | **ממשק המשתמש החדש**: כולל תמיכה בהיסטוריה, העלאת קבצים ועוד. |
