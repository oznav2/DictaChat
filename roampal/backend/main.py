#!/usr/bin/env python3
"""
Dictachat - Memory-Enhanced Hebrew locally running Chatbot system
...
async def lifespan(app: FastAPI):
    """Initialize Dictachat memory services"""
    logger.info("""
    ╔══════════════════════════════════════╗
    ║         DictaChat v1.0               ║
...
def print_mcp_banner():
    ...
    banner = """
╔══════════════════════════════════════════════════════════════╗
║                 DICTACHAT MEMORY MCP SERVER RUNNING          ║
╠══════════════════════════════════════════════════════════════╣
║  Status: Connected to AI tool                                ║
║                                                              ║
