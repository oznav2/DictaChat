...
_Phase 1: Cold Start (First 3-10 queries)_
...
_Phase 2: Learning (After 10+ queries)_
...
_Phase 3: Confident (After 20+ queries)_
...
1. **Routing KG** (`routing_patterns`, `success_rates`) - _Which collection has the answer?_

   - Maps concepts → best collection
   - Learns from search outcomes
   - Enables intelligent tier selection

2. **Content KG** (`content_graph`) - _How are entities related?_

   - Entity relationships from memory content
   - Green/purple nodes in visualization
   - Semantic connections between concepts

3. **Action-Effectiveness KG** (`context_action_effectiveness`) - _What tool should I use in this situation?_
...
_Phase 1: Bootstrap (Queries 1-10)_
...
_Phase 2: Statistical Collection (Queries 10-50)_
...
_Phase 3: Automatic Classification (Every 50 queries)_
...
_Phase 4: Dynamic Re-evaluation (Continuous)_
...
Roampal can act as an MCP _client_, connecting to external MCP tool servers just like Claude Desktop and Cursor do. This enables local LLMs to use external tools like filesystem, GitHub, Blender, databases, and more.
...
- **Enhanced Markdown rendering** (Updated 2025-10-07)
  ...
  - **Bold**, _italic_, `inline code` formatting
...
- System knows "this worked" but not _why_
...
4. **Alignment through outcomes** → Learn _appropriate_ behavior, not just _any_ behavior
...
**P1 Fixes (High Priority)**: 5. **WebSocket Heartbeat** - [useChatStore.ts:261-267](ui-implementation/src/stores/useChatStore.ts#L261)
...
**P1 Fixes (High Priority)**: 4. **Conversation Lock Usage** - [agent_chat.py:1287](app/routers/agent_chat.py#L1287)
...
**P2 Fixes (Medium Priority)**: 7. **Async Memory Promotion on Switch** - [agent_chat.py:1298-1303](app/routers/agent_chat.py#L1298)
...
<button
	...
	className="h-10 w-full border border-red-600/30 bg-red-600/10 hover:bg-red-600/20 ..."
>
...
4. **Markdown Support Added** - `TerminalMessageThread.tsx:277-363`
   - LLM can use: **bold**, _italic_, `code`, headings, lists, code blocks, callouts
