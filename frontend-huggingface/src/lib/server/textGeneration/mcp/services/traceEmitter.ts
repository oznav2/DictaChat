...
import type { TraceStep, TraceEvent, TraceStepDefinition, StepStatus } from "../types/trace";
import {
	MessageUpdateType,
...
export class TraceEmitter {
	 ...
	 * Update step status
	 */
	private updateStepStatus(runId: string, stepId: string, status: StepStatus): void {
