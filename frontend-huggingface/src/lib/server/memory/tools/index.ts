...
import {
	SEARCH_MEMORY_TOOL_DEFINITION as SearchMemoryDef,
	executeSearchMemory,
	formatSearchResultsForLLM,
} from "./searchMemoryTool";
import {
	ADD_TO_MEMORY_BANK_TOOL_DEFINITION as AddToMemoryBankDef,
	executeAddToMemoryBank,
	formatAddToMemoryBankForLLM,
} from "./addToMemoryBankTool";
import {
	RECORD_RESPONSE_TOOL_DEFINITION as RecordResponseDef,
	executeRecordResponse,
	formatRecordResponseForLLM,
} from "./recordResponseTool";
 ...
 */
export const MEMORY_TOOL_DEFINITIONS = [SearchMemoryDef, AddToMemoryBankDef, RecordResponseDef];
