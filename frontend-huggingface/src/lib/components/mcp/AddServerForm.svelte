		...
		<div class="flex items-start gap-3">
			...
			<div class="text-sm leading-5">
				...
				<p class="mt-1 text-[13px] text-amber-800 dark:text-yellow-100/90">
					שרתי כלים מאפשרים למודל להשתמש בפונקציות וכלים שעלולים לחשוף את המידע שלך ואת תוכן השיחות
					שאתה מנהל בממשק למקומות שעלולים לעשות בו שימוש זדוני. עליך להוסיף שרתים ממקור מהימן בלבד
