...
<div
	class="rtl rounded-lg border bg-gradient-to-br transition-colors {isSelected
			...
			<div class="min-w-0 flex-1">
				<div class="mb-0.5 flex items-center gap-2">
					<IconMCP
						...
						alt=""
						classNames="size-4 flex-shrink-0 rounded"
					/>
