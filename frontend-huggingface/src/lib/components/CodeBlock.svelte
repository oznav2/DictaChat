...
<div class="group relative my-4 rounded-lg">
	<div class="pointer-events-none sticky top-0 z-10 w-full">
		<div
			class="pointer-events-auto absolute flex w-full items-center justify-between rounded-t-lg border-b border-gray-200 bg-gray-100/80 px-4 py-2 backdrop-blur dark:border-gray-700 dark:bg-gray-800/80"
		>
			...
			<div class="flex items-center gap-1.5">
				...
				{/if}
				<button
					class="btn flex size-7 items-center justify-center rounded-lg border text-sm shadow-sm backdrop-blur transition-none hover:border-gray-500 active:shadow-inner dark:border-gray-600 dark:bg-gray-600/50 dark:hover:border-gray-500"
