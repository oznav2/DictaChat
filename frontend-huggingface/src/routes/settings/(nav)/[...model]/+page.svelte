...
<div class="flex flex-col items-start">
	...
	<div class="relative flex w-full flex-col gap-2">
		...
		<div class="flex w-full flex-row content-between">
			<h3 class="mb-1 text-[15px] font-semibold text-gray-800 dark:text-gray-200">פרומפט המערכת</h3>
		...
		>
			<div class="divide-y divide-gray-200 dark:divide-gray-700">
				<div class="flex items-start justify-between py-3">
					<div>
						<div class="text-[13px] font-medium text-gray-800 dark:text-gray-200">
							שימוש בכלים (Tools calling)
						</div>
						<p class="text-[12px] text-gray-500 dark:text-gray-400">
							אפשר למודל להשתמש בכלים (Tools calling)
						</p>
					</div>
				...
				<div class="flex items-start justify-between py-3">
					<div>
						<div class="text-[13px] font-medium text-gray-800 dark:text-gray-200">
							שימוש בתמונות (Multimodal support)
						</div>
						<p class="text-[12px] text-gray-500 dark:text-gray-400">
							אפשר למודל להשתמש בתמונות (Multimodal support)
						</p>
					</div>
					<Switch
